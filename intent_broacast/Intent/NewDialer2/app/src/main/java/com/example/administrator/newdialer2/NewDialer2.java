package com.example.administrator.newdialer2;
...
public class NewDialer2 extends Activity {
        ...
        button.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View b){
                ...
                if(PhoneNumberUtils.isGlobalPhoneNumber(call)){
                    ...
                    Toast.makeText(NewDialer2.this,R.string.notify_incorrect_phonenum, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
